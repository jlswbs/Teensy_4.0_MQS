// Melodic noodle 05 - random sequence with modulated delay, string and drums //
...
AudioConnection          patchCord17(string, 0, mixer2, 3);
AudioConnection          patchCord18(kick2, 0, mixer1, 3);
AudioConnection          patchCord19(mixer3, 0, out, 0);
